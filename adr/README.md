...
| [0003](0003-argocd-agent-via-acm-gitopsaddon.md) | Argo CD Agent install via RHACM 2.16 `gitopsaddon` | **Superseded by 0006 (2026-05-07)** — kept as future-migration plan |
...
| [0006](0006-poc-uses-traditional-push-based-gitops.md) | POC uses traditional push-based GitOps; Argo CD Agent deferred | Accepted 2026-05-07 |
